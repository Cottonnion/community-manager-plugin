...
(function($) {
    ...
    function initSearchHandlers() {
        ...
        $('#mlmmc-search-input').on('input', function() {
    ...
    function initLoadMoreButton() {
        $(document).on('click', '#mlmmc-load-more', function() {
    ...
    function performSearch(append = false) {
        ...
        console.log('MLMMC Debug - Performing search with filters:', {
            authors: authors,
