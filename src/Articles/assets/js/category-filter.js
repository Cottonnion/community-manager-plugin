...
function initCategoryFilter() {
    ...
    $('.mlmmc-checkbox-option input[value="all"]').on('change', function() {
        if ($(this).is(':checked')) {
    ...
    $('.mlmmc-checkbox-option input').not('[value="all"]').on('change', function() {
        if ($(this).is(':checked')) {
    ...
    $('#mlmmc-apply-categories').on('click', function() {
        ...
        $('.mlmmc-checkbox-option input:checked').not('[value="all"]').each(function() {
