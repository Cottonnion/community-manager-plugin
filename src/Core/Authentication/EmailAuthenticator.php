...
class EmailAuthenticator {
                ...
                switch ($code) {
                    case 'invalid_email':
                        ...
                        $errors->add('invalid_email', 
                            sprintf('<strong>Error:</strong> The email address <strong>%s</strong> is not registered on this site. Please check your spelling or contact support.', 
                            esc_html($email)));
                        break;
                    ...
                    case 'account_locked':
                        ...
                        if ($lockout_info && $lockout_info['minutes_remaining'] > 0) {
                            $errors->add('account_locked', 
                                sprintf('<strong>Account Temporarily Locked:</strong> Too many failed login attempts. Please try again in %d minutes.', 
   ...
   /**
    ...
    private function is_account_locked($email) {
        ...
        $email_attempts = $wpdb->get_var($wpdb->prepare(
