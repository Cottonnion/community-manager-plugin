...
class ProfileLocationHandler {
    ...
    private function __construct() {
        ...
        add_action( 'wp_ajax_save_location_coordinates', array( $this, 'ajax_save_location_coordinates' ) );
    ...
    public function ajax_save_location_coordinates() {
        ...
        wp_send_json_success( array( 'message' => 'Coordinates saved successfully' ) );
    }
