...
class RemoveHandler {
    public function __construct() {
        add_action('wp_ajax_labgenz_remove_group_member', array($this, 'handle_remove_member'));
        add_action('wp_ajax_nopriv_labgenz_remove_group_member', array($this, 'no_permission'));
    }
