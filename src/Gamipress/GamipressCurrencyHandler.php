    ...
    */
    ...
    private function display_insufficient_funds_message(int $product_id): void {
        ...
        if (strtolower($currency_select) === 'credits') {
            ...
            echo sprintf(
                __('You need %u more credits. You have %u credits.', 'text_domain'),
                $needed_credits,
                $user_credits
            );
            echo '</p>';
            ...
            echo '<p class="insufficient-funds-text">';
            echo sprintf(
                __('You need %u more activity points. You currently have %u. Earn points by completing activities.', 'text_domain'),
                $needed_points,
                $user_points
            );
            echo '</p>';
    ...
    public function check_add_to_cart_price_with_user_credits(bool $passed, int $product_id, int $quantity, $variation_id = null): bool {
        ...
        if (strtolower($currency_select) === 'credits') {
            ...
            if ($user_credits < $required_amount) {
                ...
                wc_add_notice(
                    sprintf(
                        __('You need "%u" more credits to purchase. You have "%u" credits. <a href="%s" class="btn btn-warning" target="_blank">Buy Credits</a>', 'text_domain'),
                        $needed_credits,
                        $user_credits,
                        $url
                    ),
            ...
            if ($user_points < $required_amount) {
                ...
                wc_add_notice(
                    sprintf(
                        __('You need "%u" more points to purchase. You have "%u" points.', 'text_domain'),
                        $needed_points,
                        $user_points
                    ),
                    'error'
