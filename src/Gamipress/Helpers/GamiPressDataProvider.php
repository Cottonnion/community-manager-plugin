...
class GamiPressDataProvider {
	 ...
	 */
	public static function award_points_with_log( $user_id, $points, $points_type = 'credits', $reason = 'Points awarded', $log_meta = [] ) {
	 ...
	 */
	private static function create_log_entry( $user_id, $points, $points_type, $reason, $current_points, $new_points, $log_meta = [] ) {
