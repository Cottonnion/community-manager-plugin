...
class ManageMembersTab {
    ...
    private function __construct() {
        add_action( 'bp_groups_setup_nav', array( $this, 'setup_manage_members_tab' ), 20 );
        add_action( 'bp_groups_setup_nav', array( $this, 'setup_map_members_tab' ), 20 );
        add_action( 'bp_actions', array( $this, 'remove_group_tabs' ), 5 );
    }
        ...
        if ( $this->is_user_group_organizer( $group->id, get_current_user_id() ) ) {
            ...
            bp_core_new_subnav_item(
                array(
                    ...
                    'screen_function'   => array( $this, 'display_manage_members_tab' ),
                    'position'          => 15,
    ...
    public function setup_map_members_tab() {
        ...
        bp_core_new_subnav_item(
            array(
                ...
                'parent_url'        => bp_get_group_permalink( $group ),
                'parent_slug'       => $group->slug,
                'screen_function'   => array( $this, 'display_map_members_tab' ),
                'position'          => 16,
    ...
    public function display_manage_members_tab() {
        ...
        add_action( 'bp_template_content', array( $this, 'manage_members_tab_content' ) );
    ...
    public function display_map_members_tab() {
        // Add title and content to the template
        add_action( 'bp_template_content', array( $this, 'map_members_tab_content' ) );
