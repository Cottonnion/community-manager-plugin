...
class XProfileFieldTypeHandler {
	...
	private function __construct() {
		...
		add_filter( 'bp_xprofile_get_field_types', [ $this, 'register_field_types' ] );

		// Handle field data saving
		add_action( 'xprofile_data_after_save', [ $this, 'save_location_data' ], 10, 1 );

		// Handle field data on profile update
		add_action( 'xprofile_updated_profile', [ $this, 'handle_profile_update' ], 10, 5 );

		// Initialize location field hooks
		add_action( 'init', [ $this, 'init_location_field_hooks' ], 20 );
	}
