<?php
/**
 * Template for displaying the group leaderboard
 * 
 * This template displays a leaderboard of group members based on their GamiPress activity_points
 */
...
// Get the leaderboard data (top 10 members)
...
<div class="bp-group-leaderboard-container">
    <div class="leaderboard-with-sidebar">
        <div class="leaderboard-main-content">
            <h2 class="bp-group-leaderboard-title"><?php echo esc_html__('Group Leaderboard', 'labgenz-cm'); ?></h2>
