<?php
/**
 * Template for displaying the weekly group leaderboard
 * 
 * This template displays a leaderboard of group members based on their GamiPress points earned in the last 7 days
 */
...
$leaderboard_data = $leaderboard_handler->get_weekly_group_leaderboard($group_id, 999);
...
// Calculate the date range for the weekly leaderboard
    ...
    <div class="leaderboard-with-sidebar">
        <div class="leaderboard-main-content">
            <div class="leaderboard-tabs">
                <a href="<?php echo esc_url(bp_get_group_permalink() . 'leaderboard/all-time/'); ?>" class="leaderboard-tab">All-Time Leaderboard</a>
                <a href="<?php echo esc_url(bp_get_group_permalink() . 'leaderboard/weekly/'); ?>" class="leaderboard-tab active">Weekly Leaderboard</a>
            </div>
